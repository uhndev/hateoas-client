(function () {
  ...
  AccessManagementController.$inject = ['GroupService', 'ModelService', 'RoleService', 'PermissionService', 'UserService'];

  function AccessManagementController(Group, Model, Role, Permission, User) {
    var vm = this;
